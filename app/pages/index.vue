...
import TestimonialSection from "~/components/testimonials/TestimonialSection.vue";
...
const homeDescription = `${homeSlogan}. Madar helps businesses scale through web and mobile development, UI/UX design, and data-driven digital strategies tailored for measurable growth.`;
const canonicalUrl = computed(() =>
  new URL(route.path || "/", requestURL.origin).toString()
);
const ogImageUrl = computed(() =>
  new URL(madarLogoPath, requestURL.origin).toString()
);
